"""A hello-world filter plugin in sshedmake_namespace_07.myrhdh_07."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_07 Myrhdh_07
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_07.myrhdh_07.hello_world }}"
"""
